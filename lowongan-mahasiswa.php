				...
				<div class="midit">
					<table class="table table-bordered table-hover">
						...
						<tbody>
							<tr>
								<td>IKI01010</td>
								<td>Topik Khusus Arsitektur & Infrastruktur</td>
								<td>Abdul Hadi Ismail</td>
								<td>Buka</td>
								<td>10</td>
								<td>9</td>
								<td>7</td>
								<td>
									<button type="button" class="btn btn-default">Daftar</span></button>
								</td>
							</tr>
							<tr>
								<td>IKI01010</td>
